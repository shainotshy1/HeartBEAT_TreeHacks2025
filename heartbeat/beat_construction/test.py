from heartbeat.beat_construction.beat_constructor import Note, Beat, BeatLayer, BeatBar, BPM_Manager, WavSample, SampleLibrary, TimeSignature
import pandas as pd
...
pattern_name = random.choice(list(drum_patterns.keys()))
